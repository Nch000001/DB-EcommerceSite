...
<form method="POST" action="<?= $editing ? 'product_manage_update.php' : 'product_add_save.php' ?>">
  ...
  <div class="mb-3">
    ...
    <select name="category_id" id="category_select" class="form-select" required <?= $editing ? 'disabled' : '' ?>>
  ...
  <div class="mt-4">
    ...
    <?php if ($editing): ?>
      <button type="submit" name="delete" value="1" class="btn btn-danger" onclick="return confirm('確定要刪除此商品嗎？')">刪除</button>
